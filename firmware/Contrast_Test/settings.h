...
#define SPECIAL_SETTING 124 //0x7C: The command to do special settings: baud, lines, width, backlight, splash, etc

#define SPECIAL_RESET 45 //Special command to clear display at reset cursor
#define SPECIAL_RED_MIN 128 //Minimum red/white backlight brightness
#define SPECIAL_GREEN_MIN (SPECIAL_RED_MIN+30) //Minimum green backlight brightness
